...
class Utilisateur implements UserInterface, EquatableInterface
{
    ...
    */
    ...
    public function addFraisAll(Frais $frais): self
    {
        if (!$this->fraisAll->contains($frais)) {
            $this->fraisAll[] = $frais;
            $frais->setIdCommercial($this);
        }

        return $this;
    }

    public function removeFraisAll(Frais $frais): self
    {
        if ($this->fraisAll->contains($frais)) {
            $this->fraisAll->removeElement($frais);
            // set the owning side to null (unless already changed)
            if ($frais->getIdCommercial() === $this) {
                $frais->setIdCommercial(null);
            }
        }
